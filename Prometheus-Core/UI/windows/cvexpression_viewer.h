...
class cvexpression_viewer : public window {
	...
	inline void render() override {
		if (open_window()) {
			ImGui::TextUnformatted("NOTE: Output may be wrong for some more complex expressions!");
			ImGui::TextUnformatted("Always make sure to double check if the output is right with your local Jeff from the Overwatch Developer Team!");
